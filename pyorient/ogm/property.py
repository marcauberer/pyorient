...
from .what import What, FunctionWhat, StringMethodMixin, CollectionMethodMixin, MapMethodMixin, PropertyWhat
...
class Property(PropertyWhat):
    ...
    def __init__(self, name=None, nullable=True, default=None, indexed=False,
                 unique=False, mandatory=False, readonly=False):
...
class LinkedClassProperty(Property):
    def __init__(self, linked_to=None, name=None, default=None, nullable=True,
                 unique=False, indexed=False, mandatory=False, readonly=False):
