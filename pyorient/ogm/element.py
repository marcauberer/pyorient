...
class GraphElement(object):
    ...
    def save(self):
        ...
        if not self._graph:
            raise RuntimeError('Can not save() element: it has no corresponding Graph')
    ...
    def __setattr__(self, key, value):
        ...
        if hasattr(type(self), key) and isinstance(getattr(type(self), key), pyorient.ogm.property.Property):
    ...
    def __eq__(self, other):
        return type(self) is type(other) and self._id == other._id and self._props == other._props
