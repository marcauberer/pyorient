...
class EdgeBroker(Broker):
    def create(self, from_vertex, to_vertex, **kwargs):
        return self.g.create_edge(self.element_cls, from_vertex, to_vertex, **kwargs)

    def create_command(self, from_vertex, to_vertex, **kwargs):
        return self.g.create_edge_command(self.element_cls, from_vertex, to_vertex, **kwargs)
