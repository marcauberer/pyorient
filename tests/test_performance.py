...
class PerformanceTestCase(unittest.TestCase):
    ...
    #         rids_in.append(
    #             rids[random.randint(0, num_rids_to_make - 1)])  # add more RIDs randomly from set created above
    ...
    #         rand_str = ''.join(random.choice(printable) for _ in range(str_len))
