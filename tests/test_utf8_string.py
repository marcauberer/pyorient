...
class CommandTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cluster_info = self.client.db_open(db_name, "admin", "admin", pyorient.DB_TYPE_GRAPH, "")
...
#
#        self.client.command(
#            "insert into my_v_class (  model ) values ('kfj جوزيف المعركة، بعد تم. تلك لإنعدام المعركة،')")
#
#        res = self.client.command("select from my_v_class")
#        assert res[0].model
#        assert res[0].model == 'kfjgkfgòàòT:導字社; S:导字社', \
