...
class OGMMoneyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        g = self.g = Graph(Config.from_url('money', 'root', 'root', initial_drop=True))
    ...
    def testDoubleSerialization(self):
        ...
        for value in target_values:
            ...
            original_wallet = g.wallets.create(amount_imprecise=amount_imprecise, amount_precise=amount_precise)
    ...
    def testMoney(self):
        ...
        assert g.query(Wallet)[1].amount == -42
...
class OGMDateTimeTestCase(unittest.TestCase):
    ...
    def setUp(self):
        g = self.g = Graph(Config.from_url('test_datetime', 'root', 'root', initial_drop=True))
...
class OGMEmbeddedTestCase(unittest.TestCase):
    ...
    def setUp(self):
        g = self.g = Graph(Config.from_url('test_embedded', 'root', 'root', initial_drop=True))
...
class OGMTestClassField(unittest.TestCase):
    ...
    def setUp(self):
        g = self.g = Graph(Config.from_url('custom_field', 'root', 'root', initial_drop=True))
...
class OGMTestAbstractField(unittest.TestCase):
    ...
    def setUp(self):
        g = self.g = Graph(Config.from_url('abstract_classes', 'root', 'root', initial_drop=True))
