...
class CommandTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            db = self.client.db_create(db_name, pyorient.DB_TYPE_GRAPH, pyorient.STORAGE_TYPE_MEMORY)
            pass

        self.cluster_info = self.client.db_open(db_name, "root", "root", pyorient.DB_TYPE_GRAPH, "")
    ...
    #                               '"qwerty":TRUE}')
    #     assert rec[0].abcdef is not True, "abcdef expected False: '%s'" % rec[0].abcdef
    #     assert rec[0].qwerty is True, "qwerty expected True: '%s'" % rec[0].qwerty
    #
    #     rec_value = self.client.query('select from v')
    #     assert rec_value[0].abcdef is not True, "abcdef expected False: '%s'" % rec_value[0].abcdef
    #     assert rec_value[0].qwerty is True, "qwerty expected True: '%s'" % rec_value[0].qwerty
    ...
    #     import re
    #
    #     rec = self.client.command('create vertex v content {"a":false, "q":TRUE}')
    #
    ...
    #     res = self.client.command('create vertex v content {"a":1,"b":{"d":"e"},"c":3}')
    #
    #     # print(res[0])
    #
    #     res = self.client.command('create vertex v content {"a":1,"b":{},"c":3}')
    #
    #     # print(res[0])
    #     # print(res[0].oRecordData['b'])
    #     assert res[0].oRecordData['b'] == {}, "Failed to asert that received " + res[0].oRecordData['b'] + " equals '{}"
    #
    #     res = self.client.command('create vertex v content {"a":1,"b":{}}')
    #     # print(res[0])
    #     assert res[0].oRecordData['b'] == {}, "Failed to asert that received " + res[0].oRecordData['b'] + " equals '{}"
    #
    #     res = self.client.command('create vertex v content {"b":{},"a":1,"d":{}}')
    #     # print(res[0])
    #
    #     assert res[0].oRecordData['b'] == {}, "Failed to asert that received " + res[0].oRecordData['b'] + " equals '{}"
    #     assert res[0].oRecordData['d'] == {}, "Failed to asert that received " + res[0].oRecordData['d'] + " equals '{}"

    # def test_nested_objects_1(self):
    #     res = self.client.command('create vertex v content {"b":[[1]],"a":{},"d":[12],"c":["x"]}')
    #     print(res[0])
    #
    # def test_nested_objects_2(self):
    #     res = self.client.command('create vertex v content {"b":[[1,"abc"]]}')
    #     print(res[0])
    #     assert res[0].oRecordData['b'][0][0] == 1
    #     assert res[0].oRecordData['b'][0][1] == "abc"
    #
    # def test_nested_objects_3(self):
    #     res = self.client.command('create vertex v content {"b":[[1,{"abc":2}]]}')
    #     print(res[0])
    #     assert res[0].oRecordData['b'][0][0] == 1
    #     assert res[0].oRecordData['b'][0][1]['abc'] == 2
    #
    # def test_nested_objects_4(self):
    #     res = self.client.command('create vertex v content {"b":[[1,{"abc":2}],[3,{"cde":4}]]}')
    #     print(res[0])
    #     assert res[0].oRecordData['b'][0][0] == 1
    #     assert res[0].oRecordData['b'][0][1]['abc'] == 2
    ...
    #         'create vertex v content {"b":[[1,{"dx":[1,2]},"abc"]],"a":{},"d":[12],"c":["x"],"s":111}'
    #     )
    #     assert res[0].oRecordData['b'][0][0] == 1
    ...
    #     res = self.client.command('create vertex v content {"b":[[1,2,"abc"]]}')
    #     assert res[0].oRecordData['b'][0][0] == 1
    ...
    #     res = self.client.command('create vertex v content {"b":[{"xx":{"xxx":[1,2,"abc"]}}]}')
    ...
    #     res = self.client.command(
    #         'create vertex v content {"b":[{"xx":{"xxx":[1,2,"abc"]}}],"c":[{"yy":{"yyy":[3,4,"cde"]}}]}'
    #     )
    #     assert isinstance(res[0].oRecordData['b'], list)
    #     assert isinstance(res[0].oRecordData['b'][0], dict)
    #     assert isinstance(res[0].oRecordData['b'][0]['xx'], dict)
    ...
    #     res = self.client.command('create vertex v content {"a":[[1,2],[3,4],[5,6],null]}')
    ...
    #     res = self.client.command('create vertex v content {"embedded_map":{"one":[1,2]}}')
    #
    ...
    #     res = self.client.command('create vertex v content {"embedded_map":{"one":{"three":4}}}')
    #
    #     assert isinstance(res[0].oRecordData['embedded_map'], dict)
    ...
    #     res = self.client.command('create vertex v content {"embedded_map":{"one":2}}')
    #
    #     assert isinstance(res[0].oRecordData['embedded_map'], dict)
    ...
    #
    #     record = self.client.command("CREATE VERTEX V CONTENT " + json.dumps(test_data))[0]
    #
    ...
    #     x = self.client.query("SELECT DATE('2015-01-02 03:04:05')")
    #
    #     x = x[0].oRecordData
    #
    #     import datetime
    ...
    #     )[0].sciNum
    #
    #     assert isinstance(lon1, float), "type(lon1) is not equal to 'float': %r" % type(lon1)
    #     assert isinstance(lon2, float), "type(lon2) is not equal to 'float': %r" % type(lon2)
    #     assert isinstance(lon4, float), "type(lon4) is not equal to 'float': %r" % type(lon4)
    #     assert isinstance(lon5, float), "type(lon5) is not equal to 'float': %r" % type(lon5)
    #     assert isinstance(lon3, int), "type(lon3) is not equal to 'int': %r" % type(lon3)
